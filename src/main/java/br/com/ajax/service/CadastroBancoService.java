...
public class CadastroBancoService implements Serializable {
	...
	public Banco salvar(Banco banco) {
		Banco bancoAgenciaExistente = bancoRepository.buscarPorAgencia(banco.getAgencia());
		Banco bancoNumeroExistente = bancoRepository.buscarPorNumero(banco.getNumero());

		if (bancoAgenciaExistente != null && !bancoAgenciaExistente.equals(banco)) {
			throw new NegocioException("Já existe um Banco registrado com a agência informada!");
		}
